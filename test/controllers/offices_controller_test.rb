...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { code: @office.code, location: @office.location, name: @office.name, office_type_id: @office.office_type_id } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { code: @office.code, location: @office.location, name: @office.name, office_type_id: @office.office_type_id } }
