...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { profession: @specialty.profession, specialty_id: @specialty.specialty_id } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { profession: @specialty.profession, specialty_id: @specialty.specialty_id } }
